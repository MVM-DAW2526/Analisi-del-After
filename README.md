# L'Anàlisi de l'After (Fàcil) 🍹

Objectiu: Practicar .filter() i Ternàries.

Tens una llista de consumicions d'un grup d'amics. Volem filtrar les que són "caras" i etiquetar-les.
